...
icon = Image.open("app/img/Untitled.jpeg")
st.set_page_config(
...
model = tf.keras.models.load_model("./src/models/efficientnetb4(1).hdf5")
target_size = (224, 224)
...
grad_model = tf.keras.models.Model(
    ...
    outputs=[
        grad_model.get_layer("global_average_pooling2d").input,
        grad_model.output,
    ],
)
...
if uploaded_file is not None:
    with col1:
        ...
        if st.button(
            ":arrows_counterclockwise: Predict osteoarthritis in the Knee"
        ):
